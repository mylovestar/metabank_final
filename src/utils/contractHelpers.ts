...
import {
  ...
  getBuyHandwithHodlxAddress,
  getBuyHandwithHodlAddress,
  getReferralAddress,
...
import buyHandwithToken from 'config/abi/hodlHandSale.json'
...
export const getBuyHandwithHodlxContract = (signer?: Signer | Provider) => {
  return getContract(buyHandwithToken, getBuyHandwithHodlxAddress(), signer)
}
export const getBuyHandwithHodlContract = (signer?: Signer | Provider) => {
  return getContract(buyHandwithToken, getBuyHandwithHodlAddress(), signer)
}
