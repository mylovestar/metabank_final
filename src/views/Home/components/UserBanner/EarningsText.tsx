...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and HODLX pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and HODLX pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from HODLX pool', data)
  }
