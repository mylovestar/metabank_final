...
const config = [
  {
    ...
    description: [
      <Trans>
        ...
        HODLX up to the maximum commit limit, which is published along with the IFO voting proposal. The Private Sale has
        no participation fee.
      </Trans>,
      <Trans>
        In the Public Sale, everyone with an active PancakeSwap profile can commit. However the maximum amount of HODLX
        user can commit, is equal to the average HODLX balance in the IFO HODLX pool prior to the IFO. And there’s a fee
  ...
  },
  {
    ...
    description: [<Trans>The HODLX from the participation fee will be thrown into the weekly token burn.</Trans>],
  },
  {
    title: <Trans>How can I get an achievement for participating in the IFO?</Trans>,
    description: [
      <Trans>You need to contribute a minimum of about 10 USD worth of HODLX to either sale.</Trans>,
      <Trans>
